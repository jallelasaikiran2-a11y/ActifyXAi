// ================================================================
// ActifyXAI — deepseek_inject.js  v7.2
...
(function () {
  ...
  try {
    chrome.runtime.sendMessage({ type: 'GET_PROMPT', llm: 'deepseek' }, (res) => {
      if (chrome.runtime.lastError) return;
      if (res && res.prompt) pollAndInject(res.prompt, 'deepseek');
    });
  } catch (e) { }
})();
  ...
  const timer = setInterval(() => {
    ...
    if (editorReady()) {
      ...
      chrome.runtime.sendMessage(
        { type: 'INJECT_INTO_PAGE', text, llm: 'deepseek' },
        (res) => {
